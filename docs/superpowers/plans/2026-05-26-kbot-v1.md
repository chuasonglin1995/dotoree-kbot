...
**Tech Stack:** TypeScript, Node.js 20+, Fastify, Telegraf.js (polling mode for v1), OpenAI SDK (`gpt-4.1-mini` default), Supabase JS client, `node-cron`, Jest, `tsx` for dev/seed execution.
